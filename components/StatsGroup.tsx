...
const stats = [
    { title: "Clientes satisfechos", value: 20, icon: <Person /> },
    { title: "Páginas web realizadas", value: 30, icon: <PersonalVideo /> },
    { title: "Consultas de soporte", value: 80, icon: <HeadsetMic /> },
    { title: "Casos de éxito", value: 15, icon: <EmojiEvents /> }
]
